...
def normalize_rewards_by_group(
    ...
    *,
    ...
    for positions in positions_by_group.values():
        ...
        # A lone sample is already 0 after centering, and torch.std of one element
        # is NaN (it is the sample std), which would poison the gradient. Reshaping
        # could never produce a size-1 group; grouping by prompt can.
